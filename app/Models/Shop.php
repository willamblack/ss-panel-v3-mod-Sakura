...
class Shop extends Model
{
    ...
    public function content()
    {
        ...
        foreach ($content as $key=>$value) {
            switch ($key) {
                case "bandwidth":
                    $content_text .= "<li>添加流量 ".$value." G</li>";
                    break;
                case "expire":
                    $content_text .= "<li>为账号的有效期添加 ".$value." 天</li>";
                    break;
                case "class":
                    $content_text .= "<li>为账号升级为等级 ".$value." ,有效期 ".$content["class_expire"]." 天</li>";
                    break;
                case "reset":
                    $content_text .= "<li>在 ".$content["reset_exp"]." 天内，每 ".$value." 天重置流量为 ".$content["reset_value"]." G</li>";
                    break;
                default:
            }
        }
