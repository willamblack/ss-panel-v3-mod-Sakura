                                                            ...
                                                            <div class="card">
                                                                <div class="card-main">
                                                                    <div class="card-inner">
                                                                        ...
                                                                        {if $shop->auto_renew==0}不能自动续费{else}在 <span class="label label-brand-red">{$shop->auto_renew}</span> 天后自动续费（可选）{/if}
                                                                        <p class="card-heading">续费时流量重置</p>
                                                                        <span class="label label-brand">{if $shop->auto_reset_bandwidth==0}不自动重置{else}自动重置{/if}</span>
                                                                        <hr />
